...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeLessonCategory", b =>
                {
                    b.Property<int>("TrainerDepartmentsId")
                        .HasColumnType("int");

                    b.Property<int>("TrainersId")
                        .HasColumnType("int");

                    b.HasKey("TrainerDepartmentsId", "TrainersId");

                    b.HasIndex("TrainersId");

                    b.ToTable("EmployeeLessonCategory");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6542409f-2dc5-4c78-8517-06776d7555a2",
                            Name = "owner",
                            NormalizedName = "OWNER"
                        },
                        new
                        {
                            Id = "08b0a030-be77-48a3-8891-d7dea411cffa",
                            Name = "admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "932ca792-0a69-448f-8487-f75b8eb7cb16",
                            Name = "user",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "d6ba6a74-199a-46eb-aca4-9463e11f97c0",
                            Name = "guest",
            ...
            modelBuilder.Entity("TrainingOrder", b =>
                {
                    ...
                    b.Property<string>("ClosingSignature")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EmployeeLessonCategory", b =>
                {
                    b.HasOne("LessonCategory", null)
                        .WithMany()
                        .HasForeignKey("TrainerDepartmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
